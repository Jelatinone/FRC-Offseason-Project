...
public class ProfiledPIDController implements Controller<N2,N1,N1> {
  //-----------------------------------------------------------------------[Constants]-------------------------------------------------------------------------//
  LoggedTunableNumber PROPORTIONAL_GAIN, INTEGRAL_GAIN, DERIVATIVE_GAIN;
  edu.wpi.first.math.controller.ProfiledPIDController CONTROLLER;
  //------------------------------------------------------------------------[Fields]---------------------------------------------------------------------------//
   ...
   */
  public ProfiledPIDController(final edu.wpi.first.math.controller.ProfiledPIDController Controller) {
   ...
   */
  public ProfiledPIDController(final Descriptor Descriptor) {
    this(new edu.wpi.first.math.controller.ProfiledPIDController(
